...
class StationActivity : AppCompatActivity() {
    ...
    private fun predictionChart() {
        ...
        data.add(ValueDataEntry("5 June", 25))
        data.add(ValueDataEntry("6 June", 30))
        data.add(ValueDataEntry("7 June", 15))
        data.add(ValueDataEntry("8 June", 19))
        data.add(ValueDataEntry("9 June", 34))
        data.add(ValueDataEntry("10 June", 41))
...
//        cartesian.title("Bike Sharing Demand Prediction")
//        cartesian.xAxis(0).title("Date")
//        cartesian.yAxis(0).title("Demand")
    }
